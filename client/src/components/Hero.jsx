  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative z-20 mx-auto flex min-h-[calc(100vh-86px)] w-full max-w-7xl flex-col items-center justify-start gap-22 px-4 py-8 sm:gap-4 sm:px-10 sm:py-10 lg:flex-row lg:items-center lg:justify-between lg:gap-6 lg:px-12"
      >
        <motion.div
